...
def bs_blurb_text(cat):
    ...
    if cat.status in ["kittypet", "loner", "rogue", "former Clancat"]:
        return f"This dragonet is a {cat.status} and currently resides outside of the Clans."
...
class ProfileScreen(Screens):
                ...
                if self.the_cat.dead:
                    if self.the_cat.df is True:
                        ...
                        self.the_cat.thought = (
                            "Is relieved to once again hunt in the sunrise"
                        )
                    else:
                        self.the_cat.outside, self.the_cat.exiled = False, False
                        ...
                        self.the_cat.thought = (
                            "Is distraught after being sent to the Place of No Sun"
                        )
    ...
    def clear_profile(self):
        ...
        if self.user_notes:
            self.user_notes = "Click the check mark to enter notes about your dragonet!"
    ...
    def build_profile(self):
        ...
        if is_sc_instructor:
            self.the_cat.thought = (
                "Hello. I am here to guide the dead dragonets of "
                + game.clan.name
                + "Clan into the Sunrise."
            )
        if is_df_instructor:
            self.the_cat.thought = (
                "Hello. I am here to drag the dead dragonets of "
                + game.clan.name
                + "Clan into the Eternal Night."
            )
    ...
    def save_user_notes(self):
        ...
        if (
            notes is None
            or notes == "Click the check mark to enter notes about your dragonet!"
        ):
            return
    ...
    def load_user_notes(self):
        ...
        try:
            ...
            print(
                f"ERROR: there was an error reading the Notes file of dragonet #{self.the_cat.ID}.\n",
                e,
            )
    ...
    def get_backstory_text(self):
        ...
        if (
            ...
            bs_blurb = f"This dragonet was a {self.the_cat.status} in life."
        elif self.the_cat.status in ["kittypet", "loner", "rogue", "former Clancat"]:
            bs_blurb = f"This dragonet is a {self.the_cat.status} and currently resides outside of the Clans."
    ...
    def get_apprenticeship_text(self):
        ...
        if self.the_cat.status in ["kitten", "newborn"]:
            influence_history = "This dragonet has not begun training."
        elif self.the_cat.status in [
            "apprentice",
            "medicine cat apprentice",
            "mediator apprentice",
        ]:
            influence_history = "This dragonet has not finished training."
        else:
            ...
            if valid_formor_mentors:
                ...
                influence_history += "This dragonet either did not have a mentor, or {PRONOUN/m_c/poss} mentor is unknown. "
                ...
                if self.the_cat.status == "leader":
                    ...
                    if index == death_number - 1 and self.the_cat.dead:
                        ...
                        if "This cat was" in text:
                            text = text.replace("This dragonet was", "{VERB/m_c/were/was}")
                        else:
    ...
    def get_condition_details(self, name):
        ...
        if name in self.the_cat.injuries:
            ...
            if name == "recovering from laying eggs":
            ...
            if not self.the_cat.dead:
                ...
                if self.the_cat.dead and game.clan.instructor.ID == self.the_cat.ID:
                    self.exile_cat_button = UIImageButton(
                        ...
                        "",
                        object_id=object_id,
                        tool_tip_text="Changing where this dragonet resides will change "
