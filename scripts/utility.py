...
def create_new_cat_block(
    ...
    if "meeting" in attribute_list:
        ...
        status = cat_type
        new_name = False
        thought = "Is wondering about those new dragonets"
...
def get_leader_life_notice() -> str:
    ...
    if lives > 0:
        ...
        if game.clan.instructor.df is False:
            text = "The leader has no lives left and has travelled to the Sunrise."
        else:
            text = "The leader has no lives left and has travelled to the the Place of No Sun."
...
def generate_sprite(
    ...
    #For dragonets without wings!
    elif cat.pelt.wingless and age != "newborn":
        if age in ["kitten"]:
            cat_sprite = str(21)
