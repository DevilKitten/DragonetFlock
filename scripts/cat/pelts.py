...
class Pelt:
    ...
    def __init__(self,
        ...
        self.cat_sprites = {"kitten": kitten_sprite if kitten_sprite is not None else 0,
                            ...
                            'nowing_adult': 11,
                            'nowing_senior': 15,
                            'nowing_sick_adult': 23,
                            'nowing_para_adult': 23,
                            "sick_adult": 24,
                            "sick_young": 25}
    ...
    def check_and_convert(self, convert_dict):
        ...
        if self.nowing == true:
            if self.cat_sprites['adult'] not in [11]:
                ...
                self.cat_sprites['para_adult'] = 23
        else:
            self.cat_sprites['para_adult'] = 20
        if self.cat_sprites['senior'] not in [12, 13, 14, 15]:
            if self.cat_sprites['senior'] == 4:
                self.cat_sprites['senior'] = 12
            elif self.cat_sprites['senior'] == 5:
                self.cat_sprites['senior'] = 13
            elif self.cat_sprites['senior'] == 6:
    ...
    def init_sprite(self):
        ...
        if self.nowing == True:
            ...
            self.cat_sprites['adult'] = random.randint(8, 10)
            self.cat_sprites['para_adult'] = 20
        self.cat_sprites['young adult'] = self.cat_sprites['adult']
        self.cat_sprites['senior adult'] = self.cat_sprites['adult']
