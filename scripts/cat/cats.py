...
class Cat:
        ...
        if self.status == 'leader':
            if game.clan.leader_lives > 0:
                ...
                if game.clan.instructor.df is False:
                    ...
                    text = "They've lost their last life and have travelled to the Eternal Night."
        else:
            self.dead = True
            game.just_died.append(self.ID)
        ...
        for cat in Cat.all_cats.values():
            ...
            # it can fail to to minor grief. If they have a family relation, bypass the roll.
                ...
                minor_grief_messages = (
                    ...
                    "Bargains with the Stars, begging them to send r_c back",
                    "Sat all night at r_c's vigil",
                    "Will never forget r_c",
                    "Prays that r_c sings the Morning sing among the stars",
                ...
                if body:
                    minor_grief_messages += (
                        "Helped bury r_c, leaving {PRONOUN/r_c/poss} favorite fruit at the grave",
    ...
    def get_permanent_condition(self, name, born_with=False, event_triggered=False):
        ...
        #For dragons born missing a wing
        if name == "born without wings":
            self.pelt.wingless = True
    ...
    def load_conditions(self):
        ...
        try:
            ...
            #Dragonets who lose a wing
            if "lost their wings" in self.permanent_condition and not self.pelt.wingless:
                self.pelt.wingless = True
    ...
    def get_save_dict(self, faded=False):
        if faded:
            ...
            return {
                ...
                "born without a wing": self.pelt.wingless,
                "lost a wing": self.pelt.wingless,
