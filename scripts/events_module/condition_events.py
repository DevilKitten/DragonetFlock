                ...
                if not int(random.random() * chance):
                    ...
                    if cat.age == "adolescent":
                        event = (
                            ...
                            f"hatchlings, they're warmly welcomed into the elder's den."
                        )
                        ...
                        if (
                            ...
                            event = (
                                ...
                                f"retiring early and that they would still be a valuable member of the Flock "
                                f"as an elder. {cat.name} agrees and later that day their elder ceremony "
                                f"is held."
                            )
                        else:
                            event = f"{cat.name} has decided to retire from normal Flock duty."
                    else:
                        event = (
                            f"{cat.name} has decided to retire from normal Flock duty."
                        )

                    if cat.age == "adolescent":
                        event += (
                            f" They are given the name {cat.name.prefix}{cat.name.suffix} in honor "
                            f"of their contributions to {game.clan.name}Flock."
                        )
