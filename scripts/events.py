...
class Events:
    ...
    def one_moon(self):
        ...
        if Cat.dead_cats:
            ...
            if len(Cat.dead_cats) > 1 and game.clan.game_mode != "classic":
                event = (
                    f"The past moon, {insert} have taken their place in the Sunrise. {game.clan.name}Flock mourns their "
                    f"loss, and their Flockmates will miss where they had been in their lives. Moments of their "
                ...
                if len(ghost_names) > 2:
                    ...
                    if len(shaken_cats) == 1:
                        extra_event = f"So much grief and death has taken its toll on the dragonets of {game.clan.name}Flock. {insert} is particularly shaken by it."
                    else:
                        extra_event = f"So much grief and death has taken its toll on the dragonets of {game.clan.name}Flock. {insert} are particularly shaken by it. "

            else:
                event = (
                    f"The past moon, {insert} has taken their place in the Sunrise. {game.clan.name}Flock mourns their "
                    f"loss, and their Flockmates will miss the spot they took up in their lives. Moments of their "
        ...
        if game.clan.game_mode in ["expanded", "cruel season"]:
            ...
            if not med_fullfilled:
                string = (
                    f"{game.clan.name}Flock does not have enough healthy clerics! Dragonets will be "
                    f"sick/hurt for longer and have a higher chance of dying. "
                )
                ...
                if info_dict["interaction_type"] == "hunt":
                    ...
                    if additional_kits:
                        ...
                        if len(additional_kits) > 1:
                            event_text += str(len(additional_kits)) + " hatchlings."
                        else:
                            event_text += "hatchling."
            ...
            if cat.status in _ and not int(random.random() * _[cat.status]):
                game.cur_events_list.append(
                    Single_Event(
                        ...
                        f"solve the Flock's disagreements. A meeting is called, and they "
                        f"become the Flock's newest mediator. ",
                        "ceremony",
                        cat.ID,
                    )
                )
    ...
    def get_moon_freshkill(self):
        ...
        game.freshkill_event_list.append(
            f"The flock managed to find {prey_amount} pieces of food in this moon."
        )
    ...
    def handle_focus(self):
        ...
        if game.clan.clan_settings.get(
            ...
            if total_amount > 1:
                focus_text = f"With the heightened focus of the Flock, {total_amount} additional pieces of food were gathered."
            elif total_amount == 1:
                focus_text = f"With the heightened focus of the Flock, {total_amount} additional piece of food was gathered."
            else:
                focus_text = "Despite the additional focus of the Flock, no food could be gathered."
            ...
            if herb_amount > 1:
                focus_text = f"With the additional focus of the Flock, {herb_amount} herbs were gathered."
            elif herb_amount == 1:
                focus_text = f"With the additional focus of the Flock, {herb_amount} herb was gathered."
            else:
                focus_text = f"Despite the additional focus of the Flock, no herbs could be gathered."

            log_text = (
                "With the additional focus of the Flock, following herbs were gathered: "
            )
            idx = 0
            ...
            if warrior_amount > 1:
                game.freshkill_event_list.append(
                    f"With the additional focus of the Flock, {warrior_amount} food pieces were gathered."
                )
            else:
                game.freshkill_event_list.append(
                    f"With the additional focus of the Flock, {warrior_amount} food piece was gathered."
                )
            ...
            # finish
            text_snippet = "due the additional work of hoarding herbs and fruit."
            if game.clan.clan_settings.get("raid other clans"):
                text_snippet = "while raiding other Clans to get additional fruit."
            ...
            if warrior_amount > 1 and herb_amount > 1:
                focus_text = f"With the additional focus of the Flock, {warrior_amount} pieces of food and {herb_amount} herbs were gathered."
            elif warrior_amount > 1 and herb_amount == 1:
                focus_text = f"With the additional focus of the Flock, {warrior_amount} pieces of food and {herb_amount} herb were gathered."
            elif warrior_amount > 1 and herb_amount <= 0:
                focus_text = f"With the additional focus of the Flock, {warrior_amount} pieces of food and no herbs were gathered."
            elif warrior_amount == 1 and herb_amount > 1:
                focus_text = f"With the additional focus of the Flock, {warrior_amount} piece of food and {herb_amount} herbs were gathered."
            elif warrior_amount <= 0 and herb_amount > 1:
                focus_text = f"With the additional focus of the Flock, no food and {herb_amount} herbs were gathered."
            elif warrior_amount == 1 and herb_amount == 1:
                focus_text = f"With the additional focus of the Flock, {warrior_amount} piece of food and {herb_amount} herb were gathered."
            elif warrior_amount <= 0 and herb_amount <= 0:
                focus_text = "Despite the additional focus of the Flock, neither food nor herbs could be gathered."
            else:
            ...
            if (
                ...
                if game.clan.deputy.personality.trait == "bloodthirsty":
                    text = (
                        ...
                        f"They stare down at their Flockmates with unsheathed claws, "
                        f"promising a new era for the Flocks."
                    )
                else:
                    ...
                    if c == 1:
                        text = (
                            ...
                            + " has been promoted to the new leader of the Flock. "
                        ...
                        text = (
                            f"{game.clan.deputy.name} has become the new leader of the Flock. "
                            f"They vow that they will protect the Flock, "
                        ...
                        text = (
                            ...
                            f"new leader of the Flock. They feel like "
                            f"they are not ready for this new "
                            f"responsibility, but will try their best "
                            f"to do what is right for the Flock."
                        )
    ...
    def handle_twoleg_capture(self, cat):
        ...
        cat.gone()
        # The outside-value must be set to True before the cat can go to cotc
        cat.thought = "Is terrified as they are trapped in a cage"
        ...
        if leader_invalid:
            ...
            if leader_dead or leader_outside:
                game.cur_events_list.insert(
                    0, Single_Event(f"{game.clan.name}Flock has no leader!")
                )
            ...
            if game.clan.clan_settings.get("deputy"):
                ...
                if possible_deputies:
                    ...
                    if leader_status == "here" and deputy_status == "not_here":
                        ...
                        if random_cat.personality.trait == "bloodthirsty":
                            text = (
                                ...
                                f"They look at the Flock leader with an odd glint in their eyes."
                            )
                        ...
                        text = (
                            f"The Flock is without a leader, but a "
                        ...
                        text = (
                            f"Without a leader or deputy, the Flock has been directionless. "
                        ...
                        possible_events = [
                            ...
                            f"The Flock yowls their name in approval.",  # pylint: disable=line-too-long
                            f"{random_cat.name} has been chosen as the new deputy. "  # pylint: disable=line-too-long
                            f"Some of the older Flock members question the wisdom in this choice.",
                            # pylint: disable=line-too-long
                            f"{random_cat.name} has been chosen as the new deputy. "  # pylint: disable=line-too-long
                            f"They hold their head up high and promise to do their best for the Flock.",
                            # pylint: disable=line-too-long
                            ...
                            f"announcement that {random_cat.name} will be the Flock's new deputy.",
                            # pylint: disable=line-too-long
                            f"{random_cat.name} has been chosen as the new deputy. They pray to "  # pylint: disable=line-too-long
                            f"StarClan that they are the right choice for the Flock.",  # pylint: disable=line-too-long
                    ...
                    if all_warriors:
                        ...
                        involved_cats = [random_cat.ID]
                        text = (
                            f"No dragonet is truly fit to be deputy, "
